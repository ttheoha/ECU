...
#define DHT11_OUT_PIN 9     // what digital pin we're connected to
...
float fonc_temp_DHT_out(){
  ...
  float TEOUT1 = dhtOUT.readTemperature(); // Read Fahrenheit (isFahrenheit = true)
...
float fonc_temp_DHT_in(){
  ...
  float TEIN1 = dhtIN.readTemperature(); // Read Fahrenheit (isFahrenheit = true)
